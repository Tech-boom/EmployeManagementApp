 ...
 * @author DELL
 */
public class SearchEmploye extends javax.swing.JFrame {

    /**
     * Creates new form SearchEmploye
     */
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     if(e==null){
         ...
         JOptionPane.showMessageDialog(null,"Please Inputs Digits onli","Error",JOptionPane.ERROR_MESSAGE);
      }     
      catch(SQLException e){
         JOptionPane.showMessageDialog(null,"Problem in Fetching Record"+e,"Error",JOptionPane.ERROR_MESSAGE);
      }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchEmploye.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchEmploye().setVisible(true);
            }
        });
    }

...
public class DisplayAll extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("All Employe Details");
    ...
    private void btnShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowActionPerformed
        try {
            ArrayList<Employee> emp = EmpDAO.displayAll();
            if(emp.size()==0){
            ...
            for(Employee e : emp){
                String s =e.getEmpNo()+"\t\t"+e.getEmpName()+"\t\t"+e.getEmpSal()+"\n";
                sb.append(s);
            }
            txtDisplayAll.setText(sb.toString());
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null,"Can't Fetch Record","Error",JOptionPane.ERROR_MESSAGE);
